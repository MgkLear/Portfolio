...
<pre>git clone https://github.com/MgkLear/Gulp_Light_Start.git</pre>

<ol>
	<li>Clone or <a href="https://github.com/MgkLear/Gulp_Light_Start/archive/master.zip">Download</a> <strong>OptimizedHTML 5</strong> from GitHub</li>
